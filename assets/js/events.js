...
const code1 = `class BankAccount {
    ...
    deposit(amount) {
        console.log(\`Depositing R\${amount.toLocaleString('en-ZA')}\`);
        this.balance += amount;
    }
}`;

    const code2 = `const myAccount = new BankAccount("Your Name", 5000);
...
function animateBackground(event) {
    ...
    const code3 = `/* Another code block showing movement */
